export const ASR_QA = [
  ...
  {
    scenario: 1,
    question: 'Hủy dịch vụ Mobile banking',
    answer:
      'Liên hệ với điểm giao dịch Vietcombank gần nhất để đăng ký ngừng sử dụng dịch' +
      ' vụ VCB-Mobile B@nking*Hoặc, hủy dịch vụ VCB-Mobile B@nking qua kênh ngân hàng trên internet VCB – iB@nking',
  },
  {
    scenario: 1,
    question: 'Hủy dịch vụ SMS banking',
    answer:
      'Để hủy dịch vụ này, quý khách nhắn tin theo cú pháp “VCB CD HUY” gửi tới số 6167 nhé' +
      '*Hoặc cũng có thể đề nghị hủy trực tiếp tại các phòng giao dịch của Vietcombank ạ',
  },
  {
    scenario: 1,
    question: 'Hủy dịch vụ VCBPAY',
    answer:
      'Quý khách có thể:\n' +
      '*Xóa ứng dụng VCBPAY đã kích hoạt trên thiết bị di động, quý khách không thể sử dụng dịch vụ cho đến khi tải/cài đặt ứng dụng mới trên cùng thiết bị di động hoặc thiết bị khác và làm giao dịch kích hoạt lại dịch vụ' +
      '*Liên hệ Hotline 24/7: 1900545413 để yêu cầu ngừng sử dụng dịch vụ',
  },
  {
    scenario: 1,
    question: 'Hủy dịch vụ Internet banking',
    answer:
      'Quý khách vui lòng liên hệ với điểm giao dịch Vietcombank gần nhất để thực hiện đăng ký ngừng sử dụng dịch vụ VCB-iB@nking ạ.',
  },
  {
    scenario: 1,
    question: 'Hướng dẫn làm lại thẻ',
    answer:
      'Mang Chứng minh nhân dân/Căn cước hoặc Hộ chiếu đến phòng giao dịch Vietcombank' +
  ...
  },
  {
    ...
    answer:
      'Phát hành thẻ theo quy định là 5 - 7 ngày làm việc* Tuy nhiên việc in phôi thẻ được xử lý tập trung tại Hội sở chính nên thời gian cụ thể có thể kéo dài hơn*\n' +
...

  {
    ...
    answer:
      'Sau khi đăng ký dịch vụ thành công, quý khách sẽ nhận được tin nhắn SMS từ Vietcombank thông báo đăng ký thành công và có chứa link tải ứng dụng* \n' +
  ...
  },
  {
    ...
    answer:
      'VCB-iB@nking là chương trình phần mềm ứng dụng do Vietcombank phát triển và cung cấp trên website để Quý khách có thể thực hiện các giao dịch với ngân hàng mọi lúc mọi nơi thông qua các thiết bị có kết nối Internet như máy tính, máy tính bảng, thiết bị di động, etc',
  },
  {
    scenario: 1,
    question: 'Dịch vụ Mobile Banking là gì',
    answer:
      'Dịch vụ VCB-Mobile B@nking là dịch vụ cho phép khách hàng thực hiện các giao dịch tài chính với ngân hàng và các giao dịch phi tài chính  khác ngay trên ứng dụng VCB-Mobile B@nking cài đặt trên thiết bị di động',
  },
  {
    scenario: 1,
    question: 'Dịch vụ SMS Banking là gì',
    answer:
      'Dịch vụ VCB-SMS B@nking là dịch vụ ngân hàng qua tin nhắn điện thoại di động cho phép khách hàng nhận các tin nhắn thông báo biến động số dư tài khoản tiền gửi thanh toán và chi tiêu hẻ tín dụng hoặc chủ động truy vấn thông tin, nạp tiền điện thoại thông qua việc gửi tin nhắn theo cú pháp đến đầu số 6167',
  },
  {
    scenario: 1,
    question: 'Dịch vụ Phone Banking là gì',
    answer:
      'VCB-Phone B@nking là một dịch vụ ngân hàng của VCB thông qua đầu số điện thoại cố định khách hàng có thể giao dịch với ngân hàng cung ứng dịch vụ mà không cần phải đến ngân hàng. Các dịch vụ phổ biến hiện nay cung cấp trên Phone Banking bao gồm*' +
  ...
  {
    scenario: 1,
    question: 'Dịch vụ VCBPAY là gì',
    answer:
      'VCBPAY là ứng dụng thứ cấp đầu tiên thuộc hệ sinh thái ứng dụng Mobile Banking, sử dụng chung tên đăng nhập và mật khẩu truy cập của ứng dụng VCB-Mobile B@nking* \n' +
  ...
  {
    scenario: 1,
    question: 'Tính năng VCBPAY',
    answer:
      'Với dịch vụ VCBPAY, quý khách sẽ cảm nhận được sự tiện lợi của ngân hàng khi mọi lúc mọi nơi có thể chủ động thực hiện giao dịch chuyển tiền/thanh toán dịch vụ/nạp tiền điện thoại chỉ với 01 chiếc điện thoại thông minh' +
      '*Ngoài ra, có thể tận hưởng nhiều tiện ích hấp dẫn được tích hợp trên ứng dụng của dịch vụ',
  },
  {
    scenario: 1,
    question: 'Tính năng SMS Banking',
    answer:
      'Dịch vụ VCB-SMS B@nking sẽ mang đến cho quý khách nhiều tiện ích như:\n' +
      '*Truy vấn thông tin: Tra cứu thông tin về số dư tài khoản, 05 giao dịch gần nhất và chi tiết từng giao dịch,' +
      'hạn mức các loại thẻ tín dụng,ỷ giá, lãi suất, địa điểm đặt máy ATM, quầy giao dịch Vietcombank' +
      '*Tin nhắn chủ động (SMS chủ động): Nhận tin nhắn thông báo của VCB mỗi khi có thay đổi số\n' +
      'dư tài khoản và/hoặc chi tiêu thẻ tín dụng Vietcombank của quý khách\n' +
      '*VCB-eTopup: Nạp tiền cho thuê bao di động trả trước áp dụng cho các mạng di động Vinaphone, Mobifone, Viettel thông qua tin nhắn theo cú pháp gửi về tổng đài 6167.',
  },
  {
    scenario: 1,
    question: 'Tính năng Internet Banking',
    answer:
      'Dịch vụ VCB-SMS B@nking sẽ mang đến cho quý khách nhiều tiện ích như:\n' +
      '*Truy vấn thông tin tài khoản thanh toán, tài khoản tiền gửi, tiền vay; thông tin thẻ tín dụng một cách dễ dàng' +
      '*Chuyển tiền: cho người hưởng tại Vietcombank hoặc tại ngân hàng khác (qua tài khoản hoặc qua số thẻ), chuyển tiền cho các tổ chức từ thiện mọi lúc mọi nơi.' +
      '*Thanh toán: Hóa đơn điện thoại, máy bay, điện, nước, học phí, khách sạn/du lịch,...;Dịch vụ tài chính: chứng khoán, bảo hiểm, học phí;Thanh toán thẻ tín dụng; Nạp tiền điện tử; Nộp thuế nội địa' +
      '*Tiết kiệm trực tuyến: mở/tất toán tài khoản, nộp thêm/rút tiền từ tài khoản vô cùng tiện lợi' +
      '*Tiện ích gia tăng: đăng ký/thay đổi nhu cầu sử dụng các dịch vụ Ngân hàng điện tử như đăng ký/khóa/hủy/...dịch vụ Mobile banking, Bankplus, SMS banking,...' +
      '*Công cụ truy cập nhanh và hỗ trợ tính toán (chuyển đổi ngoại tệ, tính lãi tiết kiệm, tính lịch trả nợ)',
  },
  {
    scenario: 1,
    question: 'Tính năng Mobile banking',
    answer:
      'Với dịch vụ VCB-Mobile B@nking, quý khách sẽ cảm nhận được sự tiện lợi của ngân hàng khi mọi lúc mọi nơi có thể chủ động thực hiện giao dịch chuyển tiền/thanh toán dịch vụ/nạp tiền điện thoại chỉ với 01 chiếc điện thoại thông minh' +
      '*Ngoài ra, có thể tận hưởng nhiều tiện ích hấp dẫn được tích hợp trên ứng dụng của dịch vụ',
  },
  {
    scenario: 1,
    ...
    answer:
      'Mang theo CMND/CCCD đến điểm giao dịch Vietcombank gần nhất để thực hiện thay đổi thông tin đăng ký',
  },
  {
    scenario: 1,
  ...
  },
  {
    ...
    answer:
      'Hiện tại Vietcombank đang phát hành 3 loại thẻ chính bao gồm: \n' +
  ...
  },
  {
    ...
    answer:
      'Thẻ JCB là cách mọi người gọi các thẻ thanh toán quốc tế (thẻ tín dụng, thẻ ghi nợ, và thẻ trả trước) mang thương hiệu JCB*' +
  ...
  {
    scenario: 2,
    question: 'Thẻ AMEX là thẻ gì',
    answer:
      'Thẻ American Express (Amex) là cách mọi người gọi các thẻ thanh toán quốc tế (thẻ tín dụng và thẻ ghi nợ) mang thương hiệu American Express' +
      '*American Express là công ty cung cấp công nghệ thanh toán toàn cầu có trụ sở tại Mỹ' +
      '*Công ty này xây dựng một mạng lưới thanh toán kết nối chủ thẻ, đơn vị chấp nhận thẻ (nhà hàng, trung tâm thương mại, khu nghỉ dưỡng, v.v.) và ngân hàng/tổ chức phát hành thẻ (phát hành thẻ và xử lý giao dịch), giúp các giao dịch hoàn tất nhanh chóng và dễ dàng' +
      '* Du học sinh Mỹ nên cân nhắc làm thẻ tín dụng của Amex hoặc Mastercard',
  },
  {
    scenario: 2,
  ...
  {
    scenario: 2,
    question: 'Thẻ nội địa là thẻ gì',
    answer:
      'Thẻ ATM là một loại thẻ theo chuẩn ISO 7810, dùng để thực hiện các ' +
      'giao dịch tự động như kiểm tra tài khoản, rút tiền hoặc chuyển khoản, thanh toán hóa đơn,' +
      ' mua thẻ điện thoại,etc từ máy rút tiền tự động ATM*Thẻ ATM bao gồm: Thẻ trả trước, thẻ ghi nợ và thẻ tín dụng*' +
      'Thẻ ATM nội địa (hay thẻ thanh toán nội địa) là loại thẻ ngân hàng thay cho tiền mặt, dùng để thanh toán hóa đơn ở siêu thị, cửa hàng, ' +
      'rút tiền thông qua ATM hoặc máy POS đều được* Khác với thẻ thanh toán quốc tế thì thẻ ATM nội địa chỉ có thể thanh toán trong quốc gia của bạn chứ không dùng được ở nước ngoài',
  },
  {
    scenario: 2,
    question: 'Thẻ Quốc tế là thẻ gì',
    answer: 'Không có thông tin, chuyển máy sang phòng chuyên môn',
  },
  {
    scenario: 2,
    question: 'Thẻ Tín dụng là thẻ gì',
    answer:
      'Thẻ tín dụng là thẻ được sử dụng để chi tiêu trước, trả tiền sau trong một hạn mức nhất định do ngân hàng cấp, với thời gian miễn lãi lên đến 50 ngày' +
      '*Nếu bạn chưa có tài khoản thanh toán mở tại ngân hàng, bạn vẫn có thể yêu cầu phát hành thẻ tín dụng',
  },
  {
    scenario: 2,
    question: 'Thẻ ghi nợ(debit card) là thẻ gì',
    answer:
      'Thẻ Ghi nợ là thẻ kết nối với tài khoản thanh toán của bạn mở tại ngân hàng ' +
      '*Bạn có thể sử dụng thẻ ghi nợ để chi tiêu hoặc rút tiền dựa trên số tiền bạn có trong tài khoản này' +
      '*Vì vậy, để phát hành thẻ ghi nợ của một ngân hàng, trước hết bạn phải có tài khoản thanh toán mở tại ngân hàng đó',
  },
  {
    scenario: 2,
    question: 'Thẻ ghi nợ(debit card) là thẻ gì',
  ...
  {
    scenario: 2,
    question: 'Hướng dẫn mở mới thẻ',
    answer:
      'Quý khách có thể mở thẻ theo 2 cách sau: \n' +
  ...
  },
  {
    ...
    answer:
      'Điều kiện phát hành đối với các loại thẻ của Vietcombank như sau:\n' +
  ...
  },
  {
    ...
    answer:
      'Tất cả các thông tin đều được lưu trữ trong hệ thống Vietcombank* ' +
  ...
  {
    scenario: 2,
    question: 'Hướng dẫn cấp lại thẻ',
    answer:
      'Để cấp lại thẻ quý khách vui lòng mang Chứng minh nhân dân/Căn cước hoặc Hộ chiếu đến phòng giao dịch Vietcombank gần nhất để được hướng dẫn làm thủ tục cấp lại thẻ' +
      '*Và chuẩn bị 50000 VNĐ cho phí làm thẻ.',
  },
  {
    scenario: 2,
    question: 'Phí mở thẻ',
    answer:
      'Lần đầu phát hành thẻ miễn phí, tính phí từ lần tiếp theo phát hành phôi',
  },
  {
    scenario: 2,
    question: 'Cách thanh toán thẻ',
    answer:
      'Hiện nay có 3 cách để thanh toán số dư trên tài khoản Thẻ tín dụng:' +
  ...
  },
  {
    ...
    answer:
      'Hiện tại mức lãi suất đang áp dụng với các sản phẩm thẻ tín dụng của Vietcombank từ 9%/năm đến 18%/năm tùy theo sản phẩm thẻ và hình thức cấp tín dụng thẻ',
  },
  {
    scenario: 2,
    question: 'Cách sử dụng thẻ',
    answer:
      'Quý khách có thể thanh toán tại điểm chấp nhận thanh toán thẻ như nhà hàng ăn nhanh, siêu thị, cửa hàng tiện lợi, cửa hàng café, cây xăng, nhà thuốc, hoặc các cửa hàng có máy POS',
  },
  {
    scenario: 2,
    question: 'Tính năng thẻ',
    answer:
      'Khách hàng có thể sử dụng thẻ Vietcombank để:\n' +
      '*Giao dịch tại máy ATM cảu VCB trên cả nước\n' +
      '*Hưởng lãi không kỳ hạn trên số dư tài khoản\n' +
      '*Thanh toán linh hoạt tại các đơn vị chấp nhận thẻ trên toàn quốc, bao gồm cả các điểm chấp nhận thẻ contactless, thanh toán qua Internet và các ứng dụng di động như ví điện tử MOCA;\n' +
      '*Thanh toán hóa đơn cho các dịch vụ điện nước, viễn thông, bảo hiểm, thanh toán vé máy bay online;\n' +
      '*Quản lý và kiểm soát chi tiêu thông qua các tiện ích như VCB-iB@nking, VCB-Mobile banking, SMS Banking, VCB-Phone Banking;\n',
  },
  {
    scenario: 3,
    question: 'Cách gửi tiết kiệm',
    answer:
      'Quý khách có thể đăng kí mở tài khoản thanh toán hoặc sổ tiết kiệm bằng cách:\n' +
  ...
  },
  {
    ...
    answer:
      'Tùy sản phẩm, các loại ngoại tệ sẽ được quy định từng thời kì: \n' +
  ...
  },
  {
    ...
    answer:
      'Không có thông tin*Chuyển máy đến phòng chuyên môn để tư vấn thêm*Báo với khách hàng chờ máy',
  },
  {
    scenario: 3,
  ...
  },
  {
    ...
    answer:
      'Tài khoản tiết kiệm tất toán trước hạn được xử lý như sau:\n' +
  ...
  },
  {
    ...
    answer:
      'Hồ sơ mở tài khoản tiền gửi ở VCB bao gồm: \n' +
  ...
  },
  {
    ...
    answer:
      'Vietcombank quy định mỗi người chỉ được mở 1 tài khoản thanh toán tại ngân hàng',
  },
  {
    scenario: 3,
    question: 'Điều kiện mở tài khoản',
    answer:
      'Điều kiện mở tài khoản tiết kiệm của Vietcombank khá đơn giản* Quý khách chỉ cần là một trong các đối tượng sau đây:\n' +
      ...
      'Công dân Việt Nam từ dưới 15 tuổi khi đăng ký cần có người giám hộ đi cùng',
  },
  {
    scenario: 3,
    question: 'Phí mở tài khoản',
    answer:
      'Để thuận tiện hơn quý khách có thể tham khảo biểu phí dịch vụ tài khoản của VCB theo đường link dưới đây nhé: \n' +
  ...
  },
  {
    ...
    answer:
      'Biểu phí thông tin dịch vụ Ngân hàng điện tử như sau:\n' +
  ...
  },
  {
    ...
    answer:
      'Điều kiện vay mua ô tô như sau:' +
  ...
  },
  {
    ...
    answer:
      'Điều kiện vay kinh doanh như sau:\n' +
  ...
  {
    scenario: 4,
    question: 'Chương trình ưu đãi thẻ VCB JCB',
    answer:
  ...
  {
    scenario: 4,
    question: 'Chương trình ưu đãi thẻ VCB Unipay',
    answer:
      'Chi tiêu trước, trả tiền sau với thời gian miễn lãi lên tới 45 ngày' +
      '*Thanh toán tiện lợi qua Internet, ứng dụng di động, ví điện tử MOCA' +
      '*Trả góp lãi suất 0% tại các đối tác liên kết với Vietcombank' +
  ...
  {
    scenario: 4,
    question: 'Chương trình ưu đãi thẻ VCB Mastercard',
    answer:
      'Chi tiêu trước, trả tiền sau với thời gian miễn lãi lên tới 45 ngày' +
      '*Thanh toán tiện lợi qua Internet, ứng dụng di động, ví điện tử MOCA' +
      '*Trả góp lãi suất 0% tại các đối tác liên kết với Vietcombank' +
  ...
  {
    scenario: 4,
    question: 'Chương trình ưu đãi thẻ VCB Amex(American Express)',
    answer:
  ...
  {
    scenario: 4,
    question: 'Chương trình ưu đãi thẻ VCB quốc tế',
    answer:
  ...
  {
    scenario: 4,
    question: 'Chương trình ưu đãi thẻ VCB nội địa',
    answer:
  ...
  },
  {
    ...
    answer:
      'Có 3 hình thức vay: Vay thế chấp, Vay tín chấp, Vay cầm cố giấy tờ có giá' +
      '*Hỏi khách hàng muốn vay theo hình thức nào rồi search tiếp theo chi tiết các hình thức ở thanh search',
  },
  {
    scenario: 4,
    question: 'Điều kiện vay thế chấp',
    answer:
      'Vay thế chấp (vay có đảm bảo bằng tài sản như nhà, xe ô tô, xe máy etc):' +
  ...
  {
    scenario: 4,
    question: 'Điều kiện vay tín chấp',
    answer:
      'Vay tín chấp (vay không đảm bảo bằng tài sản):\n' +
  ...
  {
    scenario: 4,
    question: 'Điều kiện vay cầm cố giấy tờ có giá',
    answer:
      'Vay cầm cố giấy tờ có giá (vay cầm cố các GTCG như tín phiếu kho bạc, trái phiếu Chính phủ):Điều kiện vay tiêu dùng bằng giấy tờ có giá như sau:' +
  ...
  },
  {
    ...
    answer:
      'Điều kiện vay mua bất động sản như sau:\n' +
      '*Mọi cá nhân có đủ năng lực pháp luật dân sự và năng lực hành vi dân sự vay vốn tại Vietcombank\n' +
  ...
  },
  {
    scenario: 4,
    question:
      'Hồ sơ vay thế chấp (vay có đảm bảo bằng tài sản như nhà, xe ô tô, xe máy ..)',
    answer:
      'Hồ sơ vay thế chấp tiêu dùng bao gồm các giấy tờ sau:' +
  ...
  {
    scenario: 4,
    question: 'Hồ sơ vay tín chấp (vay không đảm bảo bằng tài sản)',
    answer:
      'Hồ sơ vay tvín chấp tiêu dùng bao gồm các giấy tờ sau\n' +
      '*Phương án sử dụng vốn (theo mẫu)\n' +
  ...
  },
  {
    scenario: 4,
    question:
      'Hồ sơ vay cầm cố giấy tờ có giá (vay cầm cố các GTCG như tín phiếu kho bạc, trái phiếu Chính phủ)',
    answer:
      'Hồ sơ vay cầm cố GTCG cho mục đích tiêu dùng bao gồm các giấy tờ sau:\n' +
  ...
  },
  {
    ...
    answer:
      'Hồ sơ vay mua xe sẽ bao gồm các giấy tờ sau:\n' +
  ...
  },
  {
    ...
    answer:
      'Thời hạn vay tối đa 7 năm* Có thể vay bù đắp mua xe trong thời gian tối đa 3 tháng\n' +
  ...
  },
  {
    ...
    answer:
      'Với kinh doanh tài lộc, hồ sơ kinh doanh bao gồm:\n' +
      '*Phương án sử dụng vốn (theo mẫu)\n' +
  ...
  {
    scenario: 4,
    question: 'Hồ sơ vay mua nhà(bất động sản)',
    answer:
      'Hồ sơ vay mua bất động sản như sau:\n' +
      '*Phương án sử dụng vốn.\n' +
  ...
  {
    scenario: 4,
    question: 'Hồ sơ vay mua tiêu dùng',
    answer:
      'Có 3 hình thức vay: Vay thế chấp, Vay tín chấp, Vay cầm cố giấy tờ có giá' +
      '*Hỏi khách hàng muốn vay theo hình thức nào rồi search tiếp theo chi tiết các hình thức ở thanh search',
  },
  {
    ...
    answer:
      'Cho vay tiêu dùng không bảo đảm bằng tài sản: Thời gian vay linh hoạt lên tới 60 tháng\n' +
  ...
  },
  {
    ...
    answer:
      'Vietcombank chưa hỗ trợ vay vốn trực tuyến mong quý khách thông cảm',
  },
  {
    scenario: 4,
    question: 'Trả nợ trước hạn',
    answer:
      'Khách hàng được phép trả nợ trước hạn một phần hoặc toàn bộ khoản vay tại thời điểm bất kì trong thời hạn khoản vay và chịu phí phạt trả nợ trước theo quy định của Vietcombank*\n' +
  ...
  },
  {
    ...
    answer:
      'Số tiền được vay tùy thuộc vào tình hình tài chính và khả năng trả nợ của quý khách* Về thời gian vay, chúng tôi sẽ tư vấn thời gian vay phù hợp với nguồn tài chính của quý khách* \n' +
  ...
  },
  {
    ...
    answer:
      'Trường hợp chuyển tiền trong cùng hệ thống:' +
  ...
  },
  {
    ...
    answer:
      'Trường hợp quý khách không nhận được mã OTP khi giao dịch có thể do: \n' +
  ...
  },
  {
    ...
    answer:
      'Trường hợp thẻ của quý khách bị thu giữ tại ATM VCB:\n' +
  ...
  },
  {
    ...
    answer:
      'Trong trường hợp bạn là chủ thẻ VCB gặp sự cố rút tiền không thành công tài khoản bị trừ tiền tại máy ATM, bạn vui lòng liên hệ qua tổng đài 1900545413 hoặc CN/PGD VCB gần nhất để thực hiện tra soát nhé\n',
  },
  {
    scenario: 5,
  ...
  },
  {
    ...
    answer:
      'Vui lòng gọi điện thoại đến số Hotline hoặc đem theo giấy tờ tuỳ thân trực tiếp đến các điểm giao dịch của Vietcombank để đề nghị tra soát, khiếu nại' +
      '*Yêu cầu sẽ được thực hiện trong vòng 30 ngày kể từ ngày tiếp nhận yêu cầu',
  },
  {
    scenario: 5,
  ...
  {
    scenario: 5,
    question: 'Phí chuyển tiền SMS banking',
    answer:
      'Hiện tại, VCB chưa hỗ trợ dịch vụ chuyển tiền qua tin nhắn mong quý khách thông cảm',
  },
  {
    scenario: 5,
    question: 'Phí chuyển tiền Mobile banking',
    answer:
      'Cùng ngân hàng:' +
      ...
      '*Từ 10 triệu VND trở lên: 0,02% Số tiền chuyển(Tối thiểu 10.000 VND/giao dịch và Tối đa 1.000.000 VND/giao dịch',
  },
  {
    scenario: 5,
    question: 'Phí chuyển tiền internet banking',
    answer:
      'Cùng ngân hàng:' +
      '*Dưới 50 triệu VND:2.000 VND/giao dịch' +
      '*Từ 50 triệu VND trở lên:5.000 VND/giao dịch' +
  ...
  {
    scenario: 5,
    question: 'Phí chuyển tiền VCBPAY',
    answer:
      'Cùng ngân hàng:' +
      '*Dưới 50 triệu VND:2.000 VND/giao dịch' +
      '*Từ 50 triệu VND trở lên:5.000 VND/giao dịch' +
  ...
  },
  {
    ...
    answer:
      'Tổng số tiền anh chị giao dịch trong suốt thời gian 30 ngày kể từ ngày phát hành',
  },
  {
    scenario: 5,
    question: 'Số tiền được tặng',
    answer:
      'Thẻ hiện tại là thẻ {tên thương hiệu thẻ} sẽ được tặng {số tiền tương ứng} khi chi tiêu {số tiền tương ứng} trở lên trong 30 ngày kể từ ngày phát hành ạ' +
  ...
  },
  {
    ...
    answer:
      'Với thẻ tín dụng tiền thưởng sẽ hạch toán vào hạn mức thẻ' +
  ...
  },
  {
    ...
    answer:
      'Vâng để được hoàn tiền, thì a/c cần chi tiêu từ xxx triệu trở lên' +
      '**Có thể nói lung tung các con số cũng được ^^',
  },
  {
    scenario: 5,
    ...
    answer:
      'Dạ, a/c có thể thanh toán tại các điểm chấp nhận thẻ trên toàn quốc, hoặc thanh toán trực tuyến, ngoại trừ các giao dịch rút tiền mặt',
  },
  {
    scenario: 5,
    question: 'Chính sách chương trình',
    answer:
      'Dạ với loại thẻ mà anh chị đang sử dụng là {tên thương hiệu thẻ} thì mức hoàn tiền tối đa là {số tiền tương ứng hạng thẻ} đồng ạ',
  },
  {
    scenario: 5,
    question: 'Bao giờ phải chi tiêu',
    answer:
      'Dạ thời gian chi tiêu là trong vòng 30 ngày kể từ ngày phát hành thẻ',
  },
];
